...
echo "\033[1m jgigault @ http://student.42.fr9 \033[0m"; 
echo ""; 
echo "\033[1m------------------------------------------------\033[0m"; 
...
echo ""; 
echo "\033[1m------------------------------------------------\033[0m"; 
echo "\033[1mTest avec test_libft.c :\033[0m"; 
if [ -f m1/test_libft.c ]; 
then 
gcc -Wall -Werror -Wextra m1/test_libft.c -L./ -lft -o m1/a.out; 
./m1/a.out;
else 
echo "\033[31mm1/Mtest_libft.c est introuvable\033[0m"; 
fi;

echo ""; 
echo "\033[1m------------------------------------------------\033[0m"; 
echo "\033[1mTest avec main_gauthier.c :\033[0m"; 
if [ -f m2/main_gauthier.c ]; 
then 
gcc -Wall -Werror -Wextra m2/main_gauthier.c -L./ -lft -o m2/a.out; 
./m2/a.out; 
else 
echo "\033[31mm2/main_gauthier.c est introuvable\033[0m"; 
fi;

echo ""; 
echo "\033[1m------------------------------------------------\033[0m"; 
echo "\033[1mmain.c (qperez, mfontain, gabtoubl, stherman) :\033[0m"; 
if [ -f m3/main.c ]; 
then 
if [ -f ft_lstadd.c -a -f ft_lstnew.c -a -f ft_lstdel.c -a -f ft_lstdelone.c -a -f ft_lstiter.c -a -f ft_lstmap.c ]; 
then 
echo "\033[1mAVEC BONUS :\033[0m"; 
gcc -Wall -Werror -Wextra m3/main2.c -L./ -lft -o m3/a.out; 
else 
echo "\033[1mSANS BONUS :\033[0m"; 
...
echo ""; 
echo "\033[1m------------------------------------------------\033[0m"; 
echo "\033[1mmain.c (ihermell@student.42.fr) :\033[0m"; 
if [ -f m4/main.c ]; 
then 
