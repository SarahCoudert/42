...
void *mlx_init()
{
  ...
  // load font
  new_mlx->font = mlx_new_image(new_mlx, FONT_WIDTH*32, FONT_HEIGHT*3);
  i = 0;
  while (i < 4*FONT_WIDTH*32*FONT_HEIGHT*3)
    {
  ...
  new_mlx->font->vertexes[5] = -FONT_HEIGHT;
  new_mlx->font->vertexes[7] = -FONT_HEIGHT;
